    ...
    public void DrawMesh()
    {
        ...
        for (int i = 0; i < width; i++)
        {
            for (int j = 0; j < length; j++)
            {
                ...
                Vector3 two = new Vector3(getX(i), getY(heightmaps[j, i]) + 0.05f, getZ(j + 1));
                Vector3 three = new Vector3(getX(i + 1), getY(heightmaps[j, i]) + 0.05f, getZ(j + 1));
                Vector3 fore = new Vector3(getX(i + 1), getY(heightmaps[j, i]) + 0.05f, getZ(j));
                Vector3 five = new Vector3(getX(i), getY(heightmaps[j, i]) + 0.05f, getZ(j));
                Vector3 six = new Vector3(getX(i), getY(heightmaps[j, i]) + 0.05f, getZ(j + 1));
                Vector3 seven = new Vector3(getX(i + 1), getY(heightmaps[j, i]) + 0.05f, getZ(j + 1));
                Vector3 eight = new Vector3(getX(i + 1), getY(heightmaps[j, i]) + 0.05f, getZ(j));
