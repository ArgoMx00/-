...
{
	FloorVertex() {}
	FloorVertex(float x, float y, float z, float u, float v)
...
UINT FloornumElements = ARRAYSIZE(Floorlayout);
...
void BuildFloor()
{
	/*这个函数只负责创建资源，不需要任何跟contex相关的操作*/
	hr = D3DX11CompileFromFile(L"Floor.fx", 0, 0, "VS", "vs_4_0", 0, 0, 0, &FloorVS_Buffer, 0, 0);
	hr = D3DX11CompileFromFile(L"Floor.fx", 0, 0, "PS", "ps_4_0", 0, 0, 0, &FloorPS_Buffer, 0, 0);
	...
	*/
	Vertex v[] =
	{
		...
		Vertex(+3.0f, +1.0f, -1.0f, 0.0f, 0.0f, 1.0f, 1.0f),

		Vertex(+3.0f, -1.0f, -1.0f, 1.0f, 1.0f, 0.0f, 1.0f),
		Vertex(+1.0f, -1.0f, +1.0f, 0.0f, 1.0f, 1.0f, 1.0f),
		Vertex(+1.0f, +1.0f, +1.0f, 1.0f, 1.0f, 1.0f, 1.0f),
		Vertex(+3.0f, +1.0f, +1.0f, 1.0f, 0.0f, 1.0f, 1.0f),
		Vertex(+3.0f, -1.0f, +1.0f, 1.0f, 0.0f, 0.0f, 1.0f),
	};
	DWORD indices[] = {
		// front face
		0, 1, 2,
	...
	UINT offset = 0;
	d3d11DevCon->IASetVertexBuffers(0, 1, &FloorVertBuffer, &stride, &offset);

	//⑧创建输入布局
	d3d11Device->CreateInputLayout(layout, numElements, FloorVS_Buffer->GetBufferPointer(),
		FloorVS_Buffer->GetBufferSize(), &FloorVertLayout);

	//⑨设置输入布局到IA阶段

	d3d11DevCon->IASetInputLayout(FloorVertLayout);
