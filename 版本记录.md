...
void BuildFloor()
{
	hr = D3DX11CompileFromFile(L"Floor.fx", 0, 0, "Floor_VS", "vs_4_0", 0, 0, 0, &FloorVS_Buffer, 0, 0);
	hr = D3DX11CompileFromFile(L"Floor.fx", 0, 0, "Floor_PS", "ps_4_0", 0, 0, 0, &FloorPS_Buffer, 0, 0);
	...
	*/
	...
	Vertex v[] =
	{
		Vertex(+100.0f, -2.0f, +100.0f, 1.0f, 0.0f, 0.0f, 1.0f),
		Vertex(-100.0f, -2.0f, +100.0f, 0.0f, 1.0f, 0.0f, 1.0f),
		Vertex(-100.0f, -2.0f, -100.0f, 0.0f, 0.0f, 1.0f, 1.0f),
		Vertex(+100.0f, -2.0f, -100.0f, 1.0f, 1.0f, 0.0f, 1.0f),
	};
	DWORD indices[] = {
		// front face
		2, 1, 0,
